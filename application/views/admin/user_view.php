...
<div class="page-wrapper">
			...
			<div class="row align-items-center">
				...
				<div class="col-auto ms-auto d-print-none">
					<div class="btn-list">
						...
						<?php endif; ?>
						<button class="btn btn-outline-primary btn-pill" onclick="importUsersModal('<?= $userTypeId ?>', $('#customer_db_setting_id').val(), '')">
							<svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
								<path stroke="none" d="M0 0h24v24H0z" fill="none" />
								<path d="M12 5v14" />
								<path d="M5 12h14" />
							</svg>
							Import <?=$userTypeName?> CSV
						</button>
					</div>
				</div>
			</div>
				...
				<div class="col-12">
					<div class="card">
						<div class="card-header">
							...
							<div class="col-auto ms-auto d-print-none">
								<div class="btn-list" style="flex-wrap: nowrap;">
									...
									<?php if ($inputUserRight): ?>	
										<button class="btn btn-primary btn-pill" onclick="addUserModal('<?=$userTypeId?>', '-')">
											<svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
												<path stroke="none" d="M0 0h24v24H0z" fill="none" />
												<line x1="12" y1="5" x2="12" y2="19" />
												<line x1="5" y1="12" x2="19" y2="12" />
											</svg> Add <?=$userTypeName?>
										</button>
									<?php endif; ?>
								</div>
							</div>
	...
	<script>
		...
		function loadUserDatatable(customer_db_setting_id) {
			// loadDatatable('user-datatable', '<?=$userTypeName?>', base_url + 'get-user-list/<?=$userTypeId?>/' + customer_db_setting_id);
