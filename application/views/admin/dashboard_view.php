          ...
          <div class="collapse navbar-collapse" id="sidebar-menu">
            ...
            <ul class="navbar-nav pt-lg-3">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                  <a class="dropdown-item" href="<?=base_url('customer-db-config')?>"> Customer DB Settings </a>
                        ...
                        <table class="table table-vcenter table-selectable">
                          <thead>
                            <tr>
                              ...
                              <th>
                                <button class="table-sort d-flex justify-content-between" data-sort="sort-city">Reg. No.</button>
                              </th>
                              <th>
                                <button class="table-sort d-flex justify-content-between" data-sort="sort-date">Email Address</button>
                              </th>
                              <th>
                                <button class="table-sort d-flex justify-content-between" data-sort="sort-tags">Tel No.</button>
                              </th>
                              <th>
                                <button class="table-sort d-flex justify-content-between" data-sort="sort-category">Country</button>
                              </th>
                              <th>
                                <button class="table-sort d-flex justify-content-between" data-sort="sort-category">Agreement</button>
                              </th>
                              <th>
                          ...
                          <tbody class="table-tbody">
                            ...
                            <?php foreach ($customers as $index => $customer): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url('assets/uploads/' . $customer->agreement) ?>" target="_blank">Download</a>
                                    </td>
                                    <td>
    ...
    <div class="modal modal-blur fade" id="modal-report" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          ...
          <form action="<?= base_url('create-customer') ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
              ...
              <div class="col-lg-4">
                <div class="mb-3">
                  ...
                  <input type="number" class="form-control" name="tel_no" placeholder="Enter telephone no." required />
                </div>
              </div>
