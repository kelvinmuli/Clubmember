		...
		<div class="container-fluid">
			<div class="card">
				<div class="row g-0">
					...
					<?php $userOptionName = get_table('m_user_option', 'user_option_id', $user_option_id, 'name');
					if ($user_option_id == '1752581178334'): ?>
						<div class="col-12 col-md-9 d-flex flex-column">
							<div class="card-body">
								...
								<div class="row align-items-center">
									...
									<div class="col-auto">
										<a class="btn btn-pill" onclick="editUserModal('<?=$user_id?>', '<?=$membership_type_id == 'N/A' ? '1755813965588' : $membership_type_id?>', '<?=$customer_db_setting_id?>', 'profile')">
							...
							<div class="card-body">
								...
								<table id="user-vehicle-datatable" class="table table-vcenter card-table table-nowrap">
									...
									<tbody>
										...
										<?php else: ?>
											<tr>
												<td colspan="5" class="text-center">No vehicles plates added yet.</td>
											</tr>
										<?php endif; ?>
									</tbody>
								</table>
