                        ...
                        <tbody>
                          <tr>
                            <td bgcolor="#ffffff" align="left" style="padding: 20px 0 0 0; color: #666666; font-family: Helvetica Neue, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400;-webkit-font-smoothing:antialiased;"><br />
                                                <p style="margin:0;color:#585858;font-size:14px;font-weight:400;line-height:170%;">You are receiving this email because we have received a password reset request for your account.</p>
                          ...
                          <tr>
                            <td bgcolor="#ffffff" align="left" style="padding:0; color: #666666; font-family: Helvetica Neue, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400;-webkit-font-smoothing:antialiased;">
                                                <p style="margin:0;color:#585858;font-size:14px;font-weight:400;line-height:170%;">Thank you for choosing ClubMember.app - <?=$club_name?></p>

                                                <p style="margin:0;margin-top:20px;line-height:0;"></p>
                                                <p style="margin:0;color:#585858;font-size:14px;font-weight:400;line-height:170%;">Please confirm that this is your email address by clicking on the link below within 48 hours.</p>
																								<a href="<?=$url?>" target="_blank" style="background-color: #00bc87; border: none; color: white; padding: 10px 20px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer; border-radius: 12px;">RESET PASSWORD</a>
																								<p style="margin:0;margin-top:20px;line-height:0;"></p>
																								<p style="margin:0;color:#585858;font-size:14px;font-weight:400;line-height:170%;">If you did not request a password reset, no further action is required.</p>
                            </td>
                          </tr>
