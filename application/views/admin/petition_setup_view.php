							...
							<div class="row g-3 g-md-4">
								<div class="col-6 col-lg-3">
									<div class="d-flex align-items-center">
										<span class="avatar bg-blue-lt text-blue me-3"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-report" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
												<path stroke="none" d="M0 0h24v24H0z" fill="none" />
												<path d="M9 17v-5" />
												<path d="M12 17v-1" />
												<path d="M15 17v-3" />
								...
								<div class="col-6 col-lg-3">
									<div class="d-flex align-items-center">
										<span class="avatar bg-green-lt text-green me-3"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-activity" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
												<path stroke="none" d="M0 0h24v24H0z" fill="none" />
								...
								<div class="col-6 col-lg-3">
									<div class="d-flex align-items-center">
										<span class="avatar bg-cyan-lt text-cyan me-3"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-clock" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
												<path stroke="none" d="M0 0h24v24H0z" fill="none" />
												<path d="M12 7v5l3 3" />
								...
								<div class="col-6 col-lg-3">
									<div class="d-flex flex-column flex-lg-row align-items-start align-items-lg-center">
										<span class="avatar bg-purple-lt text-purple me-3 mb-2 mb-lg-0"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-signature" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
												<path stroke="none" d="M0 0h24v24H0z" fill="none" />
												<path d="M3 18c8 -12 14 -12 18 0" />
												<path d="M7 12c0 1.5 -2 3 -3 3" />
												<path d="M10 18c1.5 -1.5 3 -1.5 4.5 0" />
												<path d="M19 16l2 2l-2 2" />
											</svg></span>
										<div>
						...
						<div class="card-body border-bottom py-3">
							<div class="table-responsive">
								<table id="petition-setup-datatable" class="table table-vcenter text-wrap" style="width: 100%;">
									...
									<tbody>
										<?php $ps = 0;
										if (!empty($petitionSetupData)): foreach ($petitionSetupData as $petition): ?>
												<tr>
													<td><?= ++$ps ?>.</td>
													<td><?= $petition->name ?? '' ?></td>
													<td>
														<div class="only-so-big text-muted"><?= $petition->description ?? '' ?></div>
													</td>
														...
														<td>
															<span class="dropdown">
																...
																<div class="dropdown-menu dropdown-menu-end">
																	...
																	<?php endif;
																	if (in_array($user_type_id, array(GlobalModel::ADMIN_TYPE, GlobalModel::CLUB_ADMIN_TYPE))): ?>
