...
<head>
  ...
  <link href="<?= base_url() ?>assets/admin/dist/css/tabler-flags.css?1747674012" rel="stylesheet" />
  <link href="<?= base_url() ?>assets/admin/dist/css/tabler-socials.css?1747674012" rel="stylesheet" />
  <link href="<?= base_url() ?>assets/admin/dist/css/tabler-payments.css?1747674012" rel="stylesheet" />
  <link href="<?= base_url() ?>assets/admin/dist/css/tabler-vendors.css?1747674012" rel="stylesheet" />
  <link href="<?= base_url() ?>assets/admin/dist/css/tabler-marketing.css?1747674012" rel="stylesheet" />
  <link href="<?= base_url() ?>assets/admin/dist/css/tabler-themes.css?1747674012" rel="stylesheet" />
  <!-- END PLUGINS STYLES -->
  <!-- BEGIN DEMO STYLES -->
  <link href="<?= base_url() ?>assets/admin/preview/css/demo.css?1747674012" rel="stylesheet" />
  <!-- END DEMO STYLES -->
  <!-- BEGIN CUSTOM FONT -->
  <style>
...
<body>
  ...
  <script src="./dist/js/tabler-theme.min.js?1747674012"></script>
  ...
  <script src="<?= base_url() ?>assets/admin/dist/js/tabler.min.js?1747674013" defer></script>
  <!-- END GLOBAL MANDATORY SCRIPTS -->
  <!-- BEGIN DEMO SCRIPTS -->
  <script src="<?= base_url() ?>assets/admin/preview/js/demo.min.js?1747674013" defer></script>
  <!-- END DEMO SCRIPTS -->
  <!-- BEGIN PAGE SCRIPTS -->
  <script>
