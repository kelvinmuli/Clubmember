 ...
 <div class="container my-5">
    ...
    <div class="d-flex flex-wrap align-items-center">
      ...
      <div class="filter-box">
        <div class="filter-label">Looking for</div>
        <select>
          <option>Rent</option>
          <option>Buy</option>
        </select>
      ...
      <!-- Bathroom -->
      <div class="filter-box">
        <div class="filter-label">Bathroom</div>
        <select>
          <option>1</option>
          <option>2</option>
      ...
      <div class="filter-box">
        ...
        <input type="text" value="62000 - 64000" readonly>
      </div>
      ...
      <!-- Search Button -->
      <button class="btn btn-search ms-2 mt-2 mt-md-0">Search</button>
    </div>
  </div>
    <!-- End of filter -->
    <br>
        <h4>Latest Properties in <span class="text-warning">South Africa</span></h4>
