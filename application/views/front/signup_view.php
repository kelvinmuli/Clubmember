...
<body class="index-page">
 ...
 <div class="top-bar">
  ...
  <main class="main">
    ...
    <h4 class="fw-bold-heading text-center">Sign Up</h4>

    <!-- Main Choice -->
    <div class="main-card">
      <p>
        I want <strong>Westminster Tenant Management</strong> to manage my property
      </p>
      <p class="text-muted">
        I’m looking to partner with Westminster Tenant Management to take full responsibility
        for the day-to-day operations of my rental property. The service is offered at a competitive
        rate of 30% commission on the rental income and includes tenant management, rent collection,
        maintenance coordination, and more.
      </p>
      <div class="d-flex justify-content-center mt-3">
        <a href="<?=base_url().'register';?>">
         <button class="btn btn-warning"><i class="bi bi-envelope"></i> &nbsp; SIGN UP</button>
       </a>
</div>
    </div>
    ...
    <div class="row g-4">
      <div class="col-md-6 col-lg-6">
        <div class="signup-option text-center">
          <h5>I manage rental properties</h5>
          <p class="text-muted">
            I am an individual or professional managing a portfolio of rental properties.
            I’m looking for user-friendly tools—either basic or advanced—to streamline property
            management tasks such as tenant communication, rent collection, maintenance tracking, and reporting.
          </p>
          <a href="<?=base_url().'register';?>">
         <button class="btn btn-warning"><i class="bi bi-envelope"></i> &nbsp; SIGN UP</button>
       </a>
      ...
      <div class="col-md-6 col-lg-6">
        <div class="signup-option text-center">
          <h5>I am a real estate agent</h5>
          <p class="text-muted">
            I am an individual or professional managing a portfolio of rental properties.
            I’m looking for user-friendly tools—either basic or advanced—to streamline property
            management tasks such as tenant communication, rent collection, maintenance tracking, and reporting.
